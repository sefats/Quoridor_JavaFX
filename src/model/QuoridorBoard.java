...
public class QuoridorBoard extends GridElement {
    public QuoridorBoard(int x, int y, GameStageModel gameStageModel) {
        // call the super-constructor to create a 3x3 grid, named "quoridorboard", and in x,y in space
